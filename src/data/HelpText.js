...
const HelpTextPerp = () => {
  ...
  <p>Select how many days you want to run the backtester for and it will calculate for the strategies you have selected (Strategy1 and/ or Strategy2)</p>
 
   <p>The backtester will calculate for you:</p>
   <p>The Impermanent loss profile and liquidation point based on the entry price <b>(Impermanent loss Chart)</b><br></br>
   The <b>table</b> and <b>bar chart</b> show an overview of the past performance of the strategy selected:<br></br>
   <b>Fee ROI%</b>= percentage fee generated by the LP position in the holding period - (Fee/initial investment)<br></br>
   <b>APR % </b>= implied annualized fee return - (Fee Roi % *365 / holding period)<br></br>
   <b>Time in range</b> = Percentage time price spent between the lower and upper limit of the strategy selected <br></br>
   <b>Backtest Confidence </b>= The accuracy of the back-tester calculations depends on the amount the price spent in range. <br></br>
